...
class Player:
    ...
    def still_has_cards(self):
        """ Return true iff player still has cards left """
...
print("Computer has {} cards remaining".format(str(len(comp.hand.cards))))
print("{} has {} cards remaining.".format(user.name, str(len(user.hand.cards))))
